...
After I changed the production.rb file in order for CSS to show up on heroku, I get an error that says "Precompiling assets failed. Push rejected, failed to compile Ruby app". I have done a lot of Googling and have not been able to fix it (reinstalled bundles, tried to compile locally then push...). I am currently at a loss for what to do, but will ask in class.
